...
Route::get('/posts', [PostController::class, 'index'])->name('frontend.posts.index');
Route::get('/posts/{post:slug}', [PostController::class, 'show'])->name('frontend.posts.show');
...
Route::get('/tags/{post:slug}', [FrontendTagController::class, 'show'])->name('frontend.tags.show');
