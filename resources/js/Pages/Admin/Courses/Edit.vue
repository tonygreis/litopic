          ...
          <div class="m-2">
            ...
            <div class="m-2">
              <form @submit.prevent="addTopic" class="space-y-4">
                ...
                <Button class="bg-indigo-500 hover:bg-indigo-700"
                  >Add Topic</Button
                >
              </form>
            </div>
...
const updateCourse = () => {
  Inertia.post(`/admin/courses/${props.course.id}`, {
    _method: "put",
    name: form.name,
    slug: form.slug,
...
function addTopic() {
  ...
  topicForm.post(`/admin/courses/${props.course.id}/add-topic`, {
    onFinish: () => (topicForm.topics = props.courseTopics),
  });
}
</script>
