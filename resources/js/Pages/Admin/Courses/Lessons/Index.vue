                  ...
                  <TableRow v-for="lesson in lessons.data" :key="lesson.id">
                    ...
                    <TableData>
                      <div class="flex space-x-2">
                        <ButtonLink
                          :link="`/admin/courses/${course.id}/lessons/${lesson.id}/edit`"
                          >Edit</ButtonLink
                        >
                        <ButtonLink
...
watch(search, (value) => {
  Inertia.get(
    `/admin/courses/${props.course.id}/lessons`,
