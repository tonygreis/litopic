<template>
    <footer class="text-gray-600 body-font bg-white dark:bg-slate-900">
        <div class="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-slate-900 dark:text-slate-600">
                <span class="ml-3 text-xl">Laraveller</span>
            </a>
            <p class="text-sm text-slate-700 dark:text-slate-600 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0 mt-4">
                © 2022 Laraveller.com
            </p>
      ...
      <a href="https://twitter.com/Laravellercom"
           class="px-4 py-2 rounded-large text-slate-100 hover:text-slate-300 dark:hover:text-slate-200 dark:text-slate-600 bg-slate-500 dark:bg-slate-400 hover:bg-slate-700 dark:hover:bg-slate-700 flex"
           rel="noopener noreferrer"
           target="_blank">
          ...
          <span>Twitter</span>
                  ...
                  <a href="https://www.reddit.com/user/Laraveller"
                     class="px-4 py-2 rounded-large text-slate-100 hover:text-slate-300 dark:hover:text-slate-200 dark:text-slate-600 bg-slate-500 dark:bg-slate-400 hover:bg-slate-700 dark:hover:bg-slate-700 flex"
                     rel="noopener noreferrer"
                     target="_blank">
